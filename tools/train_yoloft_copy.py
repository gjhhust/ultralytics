...
model = YOLOFT("config/yoloft_xs_ivd/yolov8s_dcn_dy.yaml").load("pretrain/yolov8_S1_DCN_dy/best.pt") #train yolov8-l
...
results = model.train(data="config/dataset/XS-VIDv2.yaml",
                      ...
                      batch=32*2, epochs=25, imgsz=1024, device=[0,1],workers=4)
