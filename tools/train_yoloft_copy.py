...
model = YOLOFT("pretrain/yolov8s_ftv1_dim384/yolov8s_ftv1_dim384.yaml").load("pretrain/yolov8s_ftv1_dim384/yolov8s_ftv1_dim384.pt") #train yolov8-l
...
results = model.train(data="config/dataset/XS-VIDv2.yaml",
                      ...
                      batch=15*2, epochs=25, imgsz=1024, device=[2,3],workers=4)
