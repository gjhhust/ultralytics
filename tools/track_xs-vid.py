...
def track_annotate(
    ...
    print(f"Evaluating detect_model is {detect_model}")
...
test_pt = ["runs/xs-vid/train125-hyperL_12e_26.2/weights/best.pt",
           "runs/xs-vid/train98_hyperS_12e/weights/best.pt",
           "runs/xs-vid/train125_yolov8l_12e_25.9/weights/best.pt",
           "runs/xs-vid/train124_yolov8s_12e_23.6/weights/best.pt"]

for pt in test_pt:
    track_annotate(images_dir = "/data/jiahaoguo/dataset/XS-VIDv2/images/", 
                detect_model=pt,
