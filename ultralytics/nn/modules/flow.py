...
class AlternateCorrBlock:
    ...
    def __call__(self, coords):
        ...
        for i in range(self.num_levels):
            ...
            corr, = alt_cuda_corr.forward(fmap1_i, fmap2_i, coords_i, self.radius, self.stride[i])
...
class FlowHead(nn.Module):
    def __init__(self, input_dim=128, hidden_dim=256):
        ...
        self.conv1 = Conv(input_dim, hidden_dim, 3, p=1)
        self.conv2 = Conv(hidden_dim, 2, 3, p=1)
...
class SmallMotionEncoder(nn.Module):
    def __init__(self, input_dim=128, output_idm=80):
        ...
        self.convc1 = Conv(input_dim, 96, 1, p=0)
        self.convf1 = Conv(2, 64, 7, p=3)
        self.convf2 = Conv(64, 32, 3, p=1)
        self.conv = Conv(128, output_idm, 3, p=1)
