...
from .conv import Conv, DWConv, DCNV3_conv
from .transformer import MLP, DeformableTransformerDecoder, DeformableTransformerDecoderLayer
from .utils import bias_init_with_prob, linear_init

__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "DyDetect"
...
from ultralytics.nn.modules.block import normal_init, constant_init
from ultralytics.nn.modules.dyrelu import DYReLU
...
class DyHeadBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.spatial_conv_low = DyDCNv2(in_channels, in_channels, s=2)

        self.spatial_conv_offset = nn.Conv2d(
            in_channels, self.offset_and_mask_dim, 3, padding=1)
        self.scale_attn_module = nn.Sequential(
            nn.AdaptiveAvgPool2d(1), nn.Conv2d(in_channels, 1, 1),
            nn.ReLU(inplace=True), nn.SiLU())
        self.task_attn_module = DYReLU(in_channels, in_channels)
        self._init_weights()
