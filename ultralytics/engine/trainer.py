...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        """
        self.Distillation = overrides.get("Distillation", None)
        self.loss_type = overrides.get('loss_type', None)
        self.constrained = overrides.get('constrained', False)
    ...
    def _setup_train(self, world_size):
        ...
        self.optimizer = self.build_optimizer(
            model=self.model,
            model_teacher=self.Distillation,
