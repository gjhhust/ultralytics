...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            #     print("\n------------------------------------------")
            #     j = start_index + i*number_summarize
            #     stats[j] = _summarize(1, areaRng=areaRngLbl, maxDets=self.params.maxDets[2])
            #     print_j.append(j)
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 12 ** 2], [12 ** 2, 20 ** 2], [20 ** 2, 32 ** 2], [0 ** 2, 32 ** 2],  [32 ** 2, 96 ** 2], [96 ** 2, 1e5 ** 2]]
        self.areaRngLbl = ['all', '0-12', '12-20', '20-32', "small", "medium", 'large']
        self.useCats = 1
