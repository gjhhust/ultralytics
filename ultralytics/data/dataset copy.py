...
class YOLOVideoDataset(BaseDataset_2):
    ...
    def __init__(self, *args, data=None, task="detect", **kwargs):
        ...
        self.length = -1
        self.epoch = 0
        self.sub_videos, self.sub_videos_mapping = self.split_sub_videos(self.interval, -1, self.world_size, is_training = False)
    ...
    def split_sub_videos(self, interval, length, gpu_count, is_training=False):
        ...
        if not is_training:
            ...
            return self.sub_videos, self._precompute_index_mapping(all_sub_videos)
        ...
        target_multiple = lcm(gpu_count, self.batch_size)
        ...
        return all_sub_videos, self._precompute_index_mapping(all_sub_videos)
    ...
    def _train_video(self, hyp, index):
        ...
        self.sub_videos, self.sub_videos_mapping = self.split_sub_videos(self.interval, length=self.data["split_length"][index], 
    ...
    def _precompute_index_mapping(self, all_sub_videos):
        """
